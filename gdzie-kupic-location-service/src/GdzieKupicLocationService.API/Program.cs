...
try
{
    ...
    {
        var serviceName = ctx.Configuration["ServiceName"] ?? "GdzieKupicLocationService";
    ...
    app.MapGet("/health", () => Results.Ok(new { status = "healthy", service = "GdzieKupicLocationService" }));
